        ...
        return this.each(function(t, r) {
            var s = $(r)
              ...
              , f = {
                ...
                thumbnails: {
                    ...
                    item: function(e, t) {
                        ...
                        e.renderThumbnail = function(t) {
                            t && e.popup && e.popup.close && (e.popup.close(),
                            e.popup = {
                                open: e.popup.open
                            }),
                    ...
                    generateFileIcon: function(e, t) {
                        ...
                        n && (f._assets.isBrightColor(n) && (o = o.replace("${class}", " is-bright-color")),
                    ...
                    renderThumbnail: function(e, t, r) {
                        ...
                        if (i.length) {
                            if (e.image = i.html("").addClass("fileuploader-loading"),
                            (["image", "video", "audio", "astext"].indexOf(e.format) > -1 || e.data.thumbnail) && f.isFileReaderSupported() && !a && (e.appended || n.thumbnails.startImageRenderer || t)) {
                                ...
                                return ("string" == typeof r || "object" == typeof r) ? h(r) : f.files.read(e, function() {
                                    ...
                                    e.reader.node && (e.reader.frame || "img" == e.reader.node.nodeName.toLowerCase()) ? h(e.reader.frame || e.reader.src, !0) : (u("image" == e.format),
                                    c())
                                }, null, r, !0)
                            }
                            u()
                        ...
                        if (n.thumbnails.popup && n.thumbnails._selectors.popup) {
                            var r = $(n.thumbnails.popup.container)
                              ...
                              , a = function() {
                                ...
                                e.popup.move = function(t) {
                                    ...
                                    if ("prev" == t)
                                        for (var a = o; a >= 0; a--) {
                                            ...
                                            0 != a || r || i || !n.thumbnails.popup.loop || (a = f._itFl.length,
                                            i = !0)
                                        }
                                    else
                                        for (a = o; a < f._itFl.length; a++) {
                                            ...
                                            a + 1 != f._itFl.length || r || i || !n.thumbnails.popup.loop || (a = -1,
                                            i = !0)
                                        }
                                ...
                                ,
                                e.reader.node ? (d && a.find(".fileuploader-popup-node").html(e.reader.node),
                                e.reader.node.controls = !0,
                                e.reader.node.currentTime = 0,
                                e.reader.node.play && e.reader.node.play()) : a.find(".fileuploader-popup-node").html('<div class="fileuploader-popup-file-icon">' + e.icon + "</div>"),
                                $(window).on("keyup", u),
                                r.css({
                                    overflow: "hidden",
                                    width: r.innerWidth()
                                ...
                                n.thumbnails.popup.arrows ? n.thumbnails.popup.loop || (c.show(),
                                0 == f._itFl.indexOf(e) && e.popup.html.find('[data-action="prev"]').hide(),
                                f._itFl.indexOf(e) == f._itFl.length - 1 && e.popup.html.find('[data-action="next"]').hide()) : c.remove(),
                            ...
                            e.popup.editor.cropper = {
                                ...
                                resize: function(t) {
                                    ...
                                    o._resizeTimeout = setTimeout(function() {
                                        ...
                                        o.crop.cfHeight = t,
                                        o.init("resize")
                                    }, 500)) : (o.crop.cfWidth = n.width() / n.prop("naturalWidth"),
                ...
                files: {
                    add: function(e, t) {
                        var o, r, i = e._name || e.name, a = e.size, l = f._assets.bytesToText(a), p = e.type, d = p ? p.split("/", 1).toString().toLowerCase() : "", u = -1 != i.indexOf(".") ? i.split(".").pop().toLowerCase() : "", c = {
                            name: i,
                        ...
                        return "updated" != t ? (f._itFl.push(c),
                        o = f._itFl.length - 1,
                        r = f._itFl[o]) : (o = f._itFl.indexOf(e),
                        f._itFl[o] = r = c),
                        r.remove = function() {
                            f.files.remove(r)
                        }
                        ...
                        if (f.isFileReaderSupported() && !e.data.readerSkip) {
                            var d = new FileReader
                              ...
                              , h = function() {
                                ...
                                e.reader._timer && (clearTimeout(e.reader._timer),
                                delete e.reader._timer),
                            ...
                            if ("astext" == e.format)
                                ...
                                var m, g = document.createElement(e.format), v = g.canPlayType(e.type);
                                ...
                                ,
                                URL && "" !== v) {
                                    if (a && !n.thumbnails.videoThumbnail)
                                        return e.reader.node = g,
                                        h(),
                                        void (e.reader = {
                                            read: e.reader.read
                                        });
                                    ...
                                    g.onloadedmetadata = function() {
                                        ...
                                        "video" == e.format && (e.reader.width = g.videoWidth,
                                        e.reader.height = g.videoHeight,
                                        e.reader.ratio = f._assets.pxToRatio(e.reader.width, e.reader.height))
                                    }
                                    ,
                                    g.onerror = function() {
                    ...
                    remove: function(e, t) {
                        if (t || !n.onRemove || !$.isFunction(n.onRemove) || !1 !== n.onRemove(e, l, p, o, s)) {
                            ...
                            e.popup && e.popup.close && e.popup.close(),
                        ...
                        o.onload = function(e) {
                            ...
                            if (65496 == o.getUint16(0, !1))
                                for (var i = o.byteLength, a = 2; a < i && !(o.getUint16(a + 2, !1) <= 8); ) {
                                    ...
                                    if (a += 2,
                                    65505 == l) {
                                        if (1165519206 != o.getUint32(a += 2, !1))
                                            break;
